 ...
 *   some point [of object] then `glm_rotate_at()` would be better choice to do
 * so.
 *
 ...
 *   again if geometry is not perfectly centered at origin at identity
 * transform, rotation may not be around geometry.
 *
 * @param[in, out]  m      affine transform
 * @param[in]       angle  angle (radians)
 * @param[in]       axis   axis
